...
const navItems = [
  { to: '/', label: 'Home', icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#1A6BFF' : 'none'} stroke={active ? '#1A6BFF' : '#9CA3AF'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  { to: '/transactions', label: 'Txns', icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#1A6BFF' : '#9CA3AF'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 16V4m0 0L3 8m4-4l4 4"/><path d="M17 8v12m0 0l4-4m-4 4l-4-4"/>
    </svg>
  )},
  { to: '/upload', label: 'Upload', icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#1A6BFF' : '#9CA3AF'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
